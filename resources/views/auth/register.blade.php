<x-layout>
    <div class="container-fluid p-5 bg-secondary-subtle text-center bg-image">
        <div class="row justify-content-center">
            <div class="col-12">
                <h1 class="display-1 animate-title">Registrati</h1>
            </div>
        </div>
    </div>
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8">
                <form action="{{ route('register') }}" method="POST" class="card p-5 shadow hidden-element">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3 d-flex justify-content-center flex-column align-content-center">
